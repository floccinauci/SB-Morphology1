function similarity_matrix = GetDissimilarityMatrix(I, segments, adjacency_indicator, params)
...
for ind_seg1 = 1:seg_num
    for ind_seg2 = ind_seg1:seg_num
        ...
        if border_len>0
            %
            similarity_matrix(ind_seg1, ind_seg2) = SegmentsDiffHists(ind_seg1, ind_seg2, segments, I, params) * SegmentsDiffNuclei(ind_seg1, ind_seg2, segments, I, params);
        end
    end
end